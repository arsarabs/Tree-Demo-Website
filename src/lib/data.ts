...
export const SERVICES: ServiceData[] = [
  {
    ...
    longDescription:
      "If a tree is dead, leaning, or too close to your house, it needs to come down before it comes down on its own. That's the reality. Our crew takes down trees of all sizes across Contra Costa County, from small ornamentals to 80-foot valley oaks squeezed between a house and a power line. For tight spots, we rig the tree and bring it down in sections. For open lots, the crane does the work. The ground crew chips branches, cuts trunk rounds, and rakes the area clean behind the climbers. The whole site gets swept before we leave. Derek has been doing this for 25 years, and if a removal is complex, he's on site. Stump grinding can be added the same day if you want the yard fully cleared in one shot.",
    faqs: [
  ...
  },
  {
    ...
    longDescription:
      "A tree that hasn't been trimmed in five years is a liability during storm season. Dead limbs snap, overgrown canopies catch wind like sails, and branches creep onto rooflines and power lines. We handle crown thinning, crown raising, deadwood removal, and structural pruning on younger trees. Derek is ISA certified and decides what gets cut and what stays. No topping, no lion-tailing. Proper cuts at the branch collar that heal clean. Valley oak, coast live oak, bay laurel, redwood, eucalyptus, Monterey pine, and everything else you'll find in the East Bay. Branches get chipped on-site, leaves raked, driveway swept. Most trees do well with a trim every two to three years.",
    faqs: [
  ...
  },
  {
    ...
    longDescription:
      "A stump left in the ground sprouts suckers, attracts termites, and ruins your mowing line for years. The grinder chews it 8 to 12 inches below grade in about an hour. Surface roots and the root flare go too. The chips fill the hole and break down over time, or you can plant grass seed right over the top. Most stumps take 30 to 60 minutes. Big ones from oaks or eucalyptus can take a couple hours. The machine fits through a standard 36-inch gate, so backyard access is fine. Multiple stumps on the same visit get a per-stump discount. Chips raked level, area left clean.",
    faqs: [
  ...
  },
  {
    ...
    longDescription:
      "A tree on your roof at 2am is not something that can wait until Monday. Rosa answers the phone and Derek dispatches a crew. Fallen trees on roofs, split trunks across driveways, limbs in power lines. The crew stabilizes the situation first, then comes back to finish removal and cleanup once everything is safe. Insurance documentation is part of the job. Photos, written estimates, scope-of-work summaries. Most homeowner policies cover storm damage removal, and we handle the paperwork. East Bay winter storms bring atmospheric rivers and high winds that snap limbs without warning. If you have a dead tree or one with a bad lean, getting it down before storm season is cheaper and safer than dealing with it after.",
    faqs: [
  ...
  },
  {
    ...
    longDescription:
      "Overgrown eucalyptus, scrub oak, dead timber, brush. Quarter-acre backyards or multi-acre parcels prepped for construction. The crew cuts, stacks, chips, and hauls. Eucalyptus is the most common call. It grows fast, drops bark constantly, and is a real fire hazard. Selective clearing or full removal, depending on what you want. For big properties, a forestry mulcher chews through brush at ground level. For smaller residential lots, chainsaws and a chipper. Mark the trees you want to keep and the crew works around them. All debris hauled off-site unless you want the chips for mulch. Clearing brush and dead trees within 30 feet of your house is also basic fire mitigation, which matters more every year in the East Bay hills.",
    faqs: [
  ...
  },
  {
    ...
    longDescription:
      "Sometimes the right answer is to save the tree instead of removing it. Cabling uses high-strength steel cables in the upper canopy to take strain off weak branch unions. Bracing uses threaded steel rods through split trunks to hold them together. Both are often used on the same tree. Good candidates are mature oaks with heavy lateral limbs, co-dominant trunks with included bark, and storm-damaged trees that are otherwise healthy. If the tree has serious decay or root problems, cabling is not the answer. Derek assesses every candidate tree in person and will tell you straight whether it makes sense. Installed cables follow ANSI A300 Part 3 standards and should be inspected every two to three years.",
    faqs: [
