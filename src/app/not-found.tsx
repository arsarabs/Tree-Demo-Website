    ...
    <main className="min-h-[70vh] flex items-center justify-center px-6 py-24 bg-dark">
      <div className="max-w-lg text-center">
        ...
        <nav aria-label="Helpful links" className="flex flex-wrap justify-center gap-4">
          <Link
            href="/"
            className="font-satoshi text-sm px-6 py-3 bg-accent text-white font-semibold hover:bg-accent-light transition-colors min-h-[44px] flex items-center"
          >
            Home
          </Link>
          <Link
            href="/services"
            className="font-satoshi text-sm px-6 py-3 border border-accent/20 text-accent hover:border-accent/50 transition-colors min-h-[44px] flex items-center"
          >
            Services
          </Link>
          <Link
