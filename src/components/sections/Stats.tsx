...
export function Stats() {
  ...
  return (
    <SectionWrapper reveal="scale" className="relative bg-dark py-20 sm:py-24 lg:py-32 px-6 lg:px-10 overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,_rgba(26,92,75,0.06)_0%,_transparent_60%)]" />
      <div className="max-w-[90rem] mx-auto relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-20 sm:gap-10 lg:gap-0">
          ...
          <div className="lg:pl-20 lg:border-l lg:border-black/[0.08] flex flex-col justify-end">
            <p className="font-sans text-stone-dim/50 text-[11px] uppercase tracking-[0.25em] mb-4">
              Google Rating
            </p>
            ...
            <div className="flex gap-1 mt-4">
              {[...Array(5)].map((_, i) => (
                <svg key={i} width="14" height="14" viewBox="0 0 20 20" fill="#C47828" aria-hidden="true">
                  <path d="M10 1l2.39 4.84L17.3 6.7l-3.65 3.56.86 5.02L10 13.01l-4.51 2.37.86-5.02L2.7 6.8l4.91-.86L10 1z"/>
                </svg>
              ))}
              <span className="font-sans text-stone-dim/50 text-xs ml-2 self-center">
