        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-4 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            >
              <Link
                href="/services"
                className="font-sans text-stone-dim text-[13px] uppercase tracking-[0.15em] hover:text-accent transition-colors duration-300 flex items-center gap-1"
              >
                Services
              ...
              <div
                className={`absolute top-full left-0 mt-2 w-64 bg-dark/95 backdrop-blur-xl border border-black/[0.08] rounded-xl shadow-2xl transition-all duration-200 ${activeDropdown === "services" ? "opacity-100 translate-y-0 pointer-events-auto" : "opacity-0 translate-y-2 pointer-events-none"}`}
              >
                <div className="py-2">
                  <Link
                    href="/services"
                  ...
                  {SERVICES.map((s) => (
                    <Link
                      ...
                      className="block px-5 py-2.5 font-sans text-stone-dim text-sm hover:text-accent hover:bg-black/[0.02] transition-colors duration-200"
                    >
                      {s.shortName}
                    </Link>
                  ))}
            ...
            {biz.isDemo ? (
              <Link
                href="/locations"
                className="font-sans text-stone-dim text-[13px] uppercase tracking-[0.15em] hover:text-accent transition-colors duration-300"
              >
                Service Area
              </Link>
            ) : (
              ...
              >
                ...
                <div
                  className={`absolute top-full left-0 mt-2 w-56 bg-dark/95 backdrop-blur-xl border border-black/[0.08] rounded-xl shadow-2xl transition-all duration-200 ${activeDropdown === "locations" ? "opacity-100 translate-y-0 pointer-events-auto" : "opacity-0 translate-y-2 pointer-events-none"}`}
                >
                  <div className="py-2">
                    <Link
                      href="/locations"
          ...
          <div className="flex items-center gap-5">
            ...
            <Link
              href="/contact"
              className="btn-magnetic rounded-lg bg-accent text-white font-sans font-bold text-[11px] uppercase tracking-[0.18em] px-6 py-2.5 hover:bg-accent-light transition-colors duration-300"
            >
              Free Quote
            </Link>
            {/* Mobile hamburger */}
          ...
          {[
            ...
            >
              <Link
                ...
                className="font-serif font-bold text-3xl text-stone hover:text-accent transition-colors"
              >
                {link.label}
              </Link>
            </div>
