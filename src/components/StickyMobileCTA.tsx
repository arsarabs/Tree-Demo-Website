    ...
    <div className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-grove/95 backdrop-blur-xl px-4 py-3 safe-bottom">
      <div className="flex items-center gap-3 max-w-lg mx-auto">
        <a
          ...
          className="flex-1 flex items-center justify-center gap-2 bg-transparent border border-white/20 rounded-lg text-white font-sans font-bold text-xs uppercase tracking-[0.12em] py-4 hover:border-white/40 transition-colors duration-300 min-h-[52px]"
        >
